# Welcome to the Coco contributing guide!

Thank you for wanting to contribute to Coco!
...
[https://github.com/unsecretised/coco/issues] For features, see
...
└── src
    ├── app
    │   ├── apps.rs         # Logic for the "apps" / commands that Coco can perform
    │   ├── menubar.rs      # All the code related to the tray icon / menu bar icon
    │   ├── tile            # Logic for the tile (Coco window)
    │   │   ├── elm.rs      # Logic for the elm architecture of the Coco window (New and View)
    │   │   └── update.rs   # Logic for the updating (elm architecture update) of the Coco window
    ...
    ├── clipboard.rs        # Logic for the clipboard history feature of Coco
